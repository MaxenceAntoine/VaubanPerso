...
function Choice(
  ...
  Choice.prototype.printOldPrice = function () {
    return this.old_price
      ? `<p style="text-decoration: line-through;; color: red; font-weight: 600; margin-bottom: 0px !important;">
          ...
          this.old_price +
          `&nbsp;€</p>`
      : `<p class="d-none" style="margin-bottom: 0px !important;">&nbsp;</p>`;
  };
  ...
  Choice.prototype.price = function () {
    ...
    if (this.old_price == null) {
      affichage =
        `<span class="price mb-4"><span class="currency" style="color: red;">` +
        this.starting_price +
        `&nbsp;€ </span>TTC</span>`;
    } else {
      affichage =
  ...
  Choice.prototype.planLabelV2 = function () {
    ...
    if (this.isLife()) {
      label = "à vie";
    } else if (this.isFreeMonth() || this.isTrialMonth()) {
  ...
  /**
   * V2 — Bloc prix : "X mois offert(s)" pour un freemonth, prix d'essai pour un
   * trial month, sinon prix + ancien prix barré
   **/
  Choice.prototype.printPriceV2 = function () {
    ...
    if (this.isTrialMonth()) {
      return (
        `<div class="v2-price-line"><p class="v2-price">` +
        this.starting_price +
        `&nbsp;€</p><span class="v2-ttc">TTC</span></div>
        <p class="v2-after">puis ` +
        this.default_price +
        `&nbsp;€ / ` +
        convertToDurationBis(this.renewal_term_length) +
   ...
   * nombre réel de dossiers de la page. Plafond : 5 lignes affichées.
   **/
...
function convertToDuration(number, genre = 0) {
  ...
  switch (number) {
    case 1:
      ...
      break;
    case 2:
      genre == 0 ? (duration = "bimensuel") : (duration = "bimensuelle");
      break;
    case 3:
...
function customizeChoices(choices) {
  ...
  choices.forEach((choice, index) => {
    VANGUARD_LOCAL_CONFIG.choices[index].className =
      choices.length <= 4
        ? "my-1 col-md-6 col-12 mb-6 mx-auto"
...
document.addEventListener("vanguard-ready", function () {
  ...
  $('input[name="vanguard-payment-method-radio"], input[name="payment"]').on(
    "change",
    () => {
      ...
      changeRecapitulatif(choiceSelected || choices[0]);
    },
  );
