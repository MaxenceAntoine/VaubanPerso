...
<p>Je comprends que cette offre spéciale me permet de bénéficier des éditions mensuelles, le dossier cadeau et je reçois toutes les alertes. Je souscris à un abonnement ` + this.startDuration() + ` au tarif de ` + this.starting_price.toLocaleString("fr-FR", {
            style: "currency",
            currency: "EUR"
        }) + ` TTC.</p>
...
document.addEventListener("falcon-ready", function() {
                ...
                data.choices.forEach(function(choice, index) {
                    if (choice.id == id_choice) {
                        ...
                        var divAuDessus = $(`<div style="background-color: ` + colorChoice + `; color: #ffffff;" class="py-4">
                            ...
                            <h2><strong>` + choice_now.starting_price + `<sup>€</sup></strong></h2>
                            </div>
                            <div class="mt-3">
                        ...
                        if (choice_now.isSepa()) {
                            choice_div.after(`<div class="mb-2" style="color: rgb(184, 49, 47); font-size: 12px;"><p>Attention : paiement en 1clic.</p><p>Cliquer sur le bouton vous débitera de ` + choice_now.starting_price + ` € grâce à votre mandat SEPA</p>`);
                            $("#bloc_recap_sepa").append(choice_now.printRecapitulatif());
                        } else {
                            choice_div.after(`<div class="mb-2" style="color: rgb(184, 49, 47); font-size: 12px;"><p>Attention : paiement en 1clic.</p><p>Cliquer sur le bouton vous débitera de ` + choice_now.starting_price + ` € grâce à votre carte de crédit</p>`);
                            $("#bloc_recap_cc").append(choice_now.printRecapitulatif());
                        }
                    }
                });
    ...
    $("#bloc_recap_sepa").after(`<p style="font-size: 12px;">
        Vous ne souhaitez pas payer en 1 clic et préférez renseigner vos coordonnées de paiement ? 
        <a class="refus_1c" href="">Cliquez ici pour accéder au bon de commande</a>
        </p>
    ...
    `);
    $("#bloc_recap_cc").after(`<p style="font-size: 12px;">
        Vous ne souhaitez pas payer en 1 clic et préférez renseigner vos coordonnées de paiement ? 
        <a class="refus_1c" href="">Cliquez ici pour accéder au bon de commande</a>
        </p>
        <p style="font-size: 12px;">
